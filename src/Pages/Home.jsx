  ...
  return (
    <div>
      <main className="mainclass">
        ...
        <div className="herohtm2 flex flex-col lg:flex-row w-auto gap-6 lg:gap-[86px] text-center lg:text-left items-center">
          <p className="herohead2">
            From top performance to constant support, we’ve got you covered.
          </p>
<<<<<<< HEAD
          <p className="dd3 w-[408px] font-normal text-[#2D5087] text-[12px] text-2xl  justify-center pt-[20px] " style={{fontFamily: "'Inter',sans-serif", textAlign: "left"}} >
=======
